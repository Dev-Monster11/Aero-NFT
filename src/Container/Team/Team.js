...
import Josh from "../../images/josh1.png";
...
const Team = () => {
    const membersDetails = [
        ...
        },
        {
            ...
            dsc: "Systems Administrator Spencer is a coding mastermind, having worked on the backend of various projects from blockchain to video games. Spencer finds joy in repping various big-box companies at once. Does he work for Domino’s, Costco, or Waffle House? The world may never know.",
        },
    ];
    ...
    return (
        <>
            <div className="team_div">
                <h3>THE TEaM</h3>
                <p>
                    Now, with a dream to lead the way in business NFTs, this stellar team brings you AeroPups. Aero and the team are glad you’re here.
                </p>
            </div>
            ...
            <div className="team_div">
                ...
                <p>
                    The pup that started it all Aero is a rambunctious Pitsky (Pitbull-Husky) with 1% wolf DNA- giving him the optimal combination of
                    crazy, energetic, and wild. From jet-skiing to waterfall hikes, there is nothing this adventure pup loves more than exploring with
                    his humans and running wild in the great outdoors.
                </p>
            </div>
            <div style={{ overflow: "hidden" }} className="container-fluid mt-5">
                <div className="row">
                    {membersDetails.map((detail) => (
                        <div key={detail.name} className="col-md-3 team_member">
